...
exports.CandidateProjectPostgresRepository = void 0;
...
let CandidateProjectPostgresRepository = class CandidateProjectPostgresRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
...
CandidateProjectPostgresRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_postgres_service_1.PrismaPostgresService])
], CandidateProjectPostgresRepository);
exports.CandidateProjectPostgresRepository = CandidateProjectPostgresRepository;
//# sourceMappingURL=candidate-project-postgres.repository.js.map