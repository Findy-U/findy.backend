...
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'Este campo recebe um array com IDs das linguagens/ferramentas. Campo obrigatório',
        example: [1, 2, 4, 6, 7],
    }),
...
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'Este campo recebe um array com nomes dos cargos/proficionais. Campo obrigatório',
...
__decorate([
    (0, swagger_1.ApiProperty)({
        example: 'Descreva como a Sou Junior pode apoiar seu projeto. Campo opcional',
    }),
    __metadata("design:type", String)
